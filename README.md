# 🛒 Retail Sales Analytics Project | PostgreSQL 
...
## 📘 Project Overview
This project applies core SQL skills to clean, explore, and analyze retail sales data in a real-world business scenario. It involves designing a structured retail database with tables like customers, orders, products, and transactions. Using SQL functions such as GROUP BY, CASE, and window functions, the data is cleaned and explored to uncover key trends like top-selling products, regional performance, and customer purchase behavior. The analysis identifies business challenges such as low-performing categories or regions and provides insights into customer lifetime value, average order value, and the impact of discounts. Tools like **PostgreSQL along with pgAdmin** are used to run queries. This project demonstrates how SQL can turn raw sales data into meaningful business insights for strategic decision-making.
